...
package com.telecometude.eleveapp.actionbar;
...
public class ActionBarHelperBase extends ActionBarHelper {
	 ...
	 * {@link android.view.MenuItem}. If the menu item ID is <code>menu_refresh</code>, the menu
	 * item's state can be changed to show a loading spinner using
	...
	private View addActionItemCompatFromMenuItem(final MenuItem item) {
		...
		actionButton.setLayoutParams(new ViewGroup.LayoutParams((int) mActivity.getResources().getDimension(
				itemId == android.R.id.home ? R.dimen.actionbar_compat_button_home_width : R.dimen.actionbar_compat_button_width), ViewGroup.LayoutParams.FILL_PARENT));
		...
		if (item.getItemId() == R.id.menu_refresh) {
			...
			indicatorLayoutParams
					.setMargins((buttonWidth - progressIndicatorWidth) / 2, (buttonHeight - progressIndicatorWidth) / 2, (buttonWidth - progressIndicatorWidth) / 2, 0);
